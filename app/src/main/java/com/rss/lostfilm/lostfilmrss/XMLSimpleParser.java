...
public class XMLSimpleParser
{
    ...
    ArrayList<String> xml_list_blocks = new ArrayList<String>();
        ...
        /*
        string xml_block_START="<";
        string xml_block_END="</";
    ...
    public XMLSimpleParser() {
            /*xml_data_length=data.Length;
            if(xml_data_length!=0)
            {this.xml_data=data; bool_data_status=true;}
            else
            {bool_data_status=false;}*/
    }

    /*
    public String GetTextInsideBlock(String _block) {
        ...
        for (i = 0; i < icount; i++) {
            ...
            if (itemplen == iblocklength) {
                ...
                if (stemp.substring(0, iblocklength) == _block) {
            ...
            if (bool_found_tag == true && (iblocklength + 1) == itemplen) {
                ...
                for (j = i + 1; j < icount; j++) {
                    ...
                    {
                        if (stemp == _blockend)//if equal first chars
                        {
                            //char ch=stemp[iblockendlength+1];
                            //if(str_delim.IndexOf(ch)!=-1)//if this it
                            {
                                break;
                            }
                        }
                    } else {
                        sret += xml_list_blocks.get(i + 1);
                    }
                }
    ...
    public ArrayList<String> GetTextInsideBlock(String _block, boolean exit_on_first_found) {
        ...
        for (i = 0; i < icount; i++) {
            ...
            if (itemplen == iblocklength) {
                ...
                //String f=stemp.substring(0, iblocklength);
